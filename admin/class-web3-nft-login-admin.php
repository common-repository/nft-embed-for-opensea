 ...
 */
 ...
 class Web3_Nft_Login_Admin {
	...
	public function web3_nft_login_admin_menu(){
		...
		$page = add_menu_page( 'OpenSea NFT Embed ' . __( 'OpenSea NFT Embed', 'opensea_integration' ), 'OpenSea NFT Embed', $addmenuforrole, 'opensea_integration', array( $this, 'opensea_integration' ) , dirname(plugin_dir_url(__FILE__)) . '/images/icon.png');
